...
//    private Bitmap topBitmap;
    ...
    private void init() {
        ...
        localPaint.setColor(getResources().getColor(R.color.sticker_blue));
...
//        topBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.icon_top_enable);
        deleteBitmap = Utils.getBitmapFromVectorDrawable(getContext(),R.drawable.ic_sticker_delete);
//        flipVBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.icon_flip);
        resizeBitmap = Utils.getBitmapFromVectorDrawable(getContext(),R.drawable.ic_sticker_move_scale);
